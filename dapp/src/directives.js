            ...
            */
            scope.$watch(function () {
              ...
              function () {
                ...
                if (address && Web3Service.isAddress(address)) {
          ...
          link: function (scope, element, attrs) {
            ...
            var unwatchAddress = scope.$watch(function () {
              ...
              function () {
                ...
                else if (Web3Service.isAddress(attrs.disabledIfInvalidAddress)
                  || Web3Service.isAddress(Web3Service.toChecksumAddress(attrs.disabledIfInvalidAddress))) {
                  // Address valid (0x0........)
                  isAddressValid = true;
                }
                else {
